...
```url
https://user.uploads.dev/file/31001f2753367314a220458daa07deab.jpeg
```
...
```md
[AI; hiddenFrom=ai]: _Remember that the AI can make mistakes, and isn't a real medical professional. Think of it like an "interactive journal" that can help guide your thinking, and help your thoughts flow in a productive direction._
